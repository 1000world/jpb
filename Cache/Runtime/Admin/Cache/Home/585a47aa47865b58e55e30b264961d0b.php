...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/jpb/Public/Min/?f=/jpb/Public/stylesheets/admin/base.css|/jpb/Public/javascripts/admin/asyncbox/skins/default.css" />
</head>

<body class="loginWeb">
    <div class="loginBox">
        <div class="innerBox">
            <div class="logo"> <img src="/jpb/Public/images/admin/logo.png" /></div>
            <form>
                <div class="loginInfo">
                    <ul>
